...
const Login = () => {
  useSEO({
    title: 'Login',
    description: 'Log in to your ReviewHub analyst or admin account to manage and analyze reviews.',
  });
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[var(--bg-base)]">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--text-muted)] font-medium">Please enter your details</p>
        </div>
